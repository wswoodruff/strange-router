...
const { Switch, Route, Redirect, useRouteMatch } = require('react-router-dom');
...
internals.renderRoute = function RenderPath(routes, basePath, onUpdate) {
    ...
    return function RenderRoute(route) {
        ...
        // TODO
        // Do we handle this by debouncing returning a redirect here?
        // Possibly in an HOC — could wait to see if there are more specific redirects
        // and return the one with the most specific match
        if (route.redirect) {

            // detectMoreSpecificRedirect
            // if (moreSpecificRedirectDetected(route)) {
            //     //
            // }
