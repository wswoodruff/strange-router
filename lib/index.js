...
internals.RouteComponentLifecycleWrapper = function RouteComponentLifecycleWrapper(props) {
    ...
    useEffect(() => {
        ...
        const runPre = async (func) => {
            ...
            // onMount is effect-ful
            // We shouldn't suspend rendering until it's resolved
            // Let it run free
            onMount(effectProps);
    ...
    const { renderFallback, render, ...rest } = (propsSnapshotRef.current || props);
