...
// Redirects to '/404' for non-matching routes
...
it.only('Redirects to nearest ancestor redirect or "/404" for non-matching paths', () => {
    ...
    renderWithRouter(
        ...
        <Routes debug routes={routeConfig} />
    );
...
////////// TODO — falls back to nearest ancestor redirect

it('Warns on and recovers from bad config for routes with path "/"', () => {
    ...
    const routeConfig = [
        {
            path: '/',
            // This component will never receive children because '/also-moving' will be moved to be a sibling.
            // 'Base path route' will only be rendered at path '/'.
            component: componentWithChildren('Base path route'),
            childRoutes: [
                {
                    path: '/also-moving',
                    component: () => 'Also moving route'
                }
            ]
        },
        {
            ...
            childRoutes: [
                {
                    path: '/',
                    // This component will never receive children because '/surprise' will be moved to be a sibling.
                    component: componentWithChildren('Root route base path'),
                    childRoutes: [
                        {
                            path: '/surprise',
                            component: () => 'Surprise route'
                        }
                    ]
                },
                {
