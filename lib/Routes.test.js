...
it('renders a simple route', () => {
    ...
    strangeAfterEach('renders a simple route');
});
...
it('renders different routes given an array of routes', () => {
    ...
    strangeAfterEach('renders different routes given an array of routes');
});
...
it('passes childRoute as "children" prop', () => {
    ...
    strangeAfterEach('passes childRoute as "children" prop');
});
...
it('renders childRoutes many levels deep', () => {
    ...
    strangeAfterEach('renders childRoutes many levels deep');
});
...
it('redirects "to" a fallback route if no other routes match', () => {
    ...
    strangeAfterEach('redirects "to" a fallback route if no other routes match');
});
...
it('Internally consolidates routes with path "/"', async () => {
    ...
    strangeAfterEach('Internally consolidates routes with path "/"');
});
...
it('waits for "pre" to resolve before rendering a route', async () => {
    ...
    expectText('Root route');
    strangeAfterEach('waits for "pre" to resolve before rendering a route');
});
...
it('renders "fallback" when specifying a "pre" function', async () => {
    ...
    strangeAfterEach('renders "fallback" when specifying a "pre" function');
});
...
it('renders "fallback" as children in "component" when "wrapFallbackWithComponent" is true, waits to render path children until "pre" resolves', async () => {
    ...
    expectMissingText('Fallback');
    expectText('Sub route');
    strangeAfterEach('renders "fallback" as children in "component" when "wrapFallbackWithComponent" is true, waits to render path children until "pre" resolves');
});
...
it('redirects "from" a specific route "to" another', () => {
    ...
    expectHistoryPathnameEquals(history, '/login');
    strangeAfterEach('redirects "from" a specific route "to" another');
});
